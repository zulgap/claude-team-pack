...
| 12 | visuals | 자리 / 종류(표·도식·사진) / 소싱(동료사실사진→도식→공공캡쳐→AI생성)<br>🔴 **이미지 최소 1장·최대 5장, 권장 2~3장** — 표는 이 개수에 **안 들어간다**(도구가 이미지만 센다) |
...
`images.min: 1`은 하한이지 목표가 아니다 — 실측 사고 2건이 전부 "하한만 채운 과소 배치"였다.
